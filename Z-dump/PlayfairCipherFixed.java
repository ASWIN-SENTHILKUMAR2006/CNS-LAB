...
public class PlayfairCipherFixed {
    ...
    private List<String> prepareText(String text) {
        ...
        while (i < text.length()) {
            ...
            if (i + 1 < text.length()) {
                ...
                if (first == second) { 
                    second = 'X';
                    i++;  // Move forward by 1, will process duplicate again
                } else {
            ...
            // REMOVED THE BUGGY LINE: if (i == text.length() - 1 && i < text.length()) i++;
        }
        return digraphs;
    }
    ...
    public static void main(String[] args) {
        ...
        PlayfairCipherFixed pf = new PlayfairCipherFixed();
